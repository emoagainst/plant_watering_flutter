...
class PlantWateringKeys {
  static const homeScreen = Key('__homeScreen__');

  static const plantsGrid = Key('__plantsKey__');
  static const wateringCalendar = Key('__wateringCalendar__');

  static const addPlantScreen = Key('__addPlantScreen__');
